/**
 * Save/resume build state to .mlst/runs/<id>/ directory.
 */
...
export async function saveState(state: BuildState, stateDir: string = '.mlst'): Promise<string> {
...
export async function loadState(runId: string, stateDir: string = '.mlst'): Promise<BuildState> {
...
export async function listRuns(stateDir: string = '.mlst'): Promise<Array<{ id: string; phase: string; updatedAt: string; input: string }>> {
