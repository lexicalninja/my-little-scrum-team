 ...
 * Exposes MLST tools and resources to MCP-compatible hosts (Claude Code, Cursor).
 */
...
export async function startMCPServer(config: MLSTConfig, port?: number): Promise<void> {
