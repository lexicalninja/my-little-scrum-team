...
My Little Scrum Team (MLS) is a multi-agent orchestration system for [pi.dev](https://pi.dev) that turns a natural language description into a **complete, tested, reviewed feature**.
...
MLS takes this one sentence and:
...
MLS is **seven specialist agents working in parallel**:
