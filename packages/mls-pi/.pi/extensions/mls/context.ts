/**
 * MLS Pi Extension — Context Assembly
 *
...
export class ContextAssembler {
  ...
  /**
   * Build the Phase 1 prompt for the `mls-spec-writer` agent.
   *
  ...
  /**
   * Build the Phase 2 prompt for the `mls-scrum-master` agent.
   *
  ...
  /**
   * Build the legacy (non-TDD) implementation prompt for the `mls-impl-engineer` agent.
   *
  ...
  /**
   * Build the fast-path bug-fix prompt for the `mls-impl-engineer` agent.
   *
  ...
  /**
   * Build the scaffold phase prompt for the `mls-impl-engineer` agent.
   *
  ...
  /**
   * Build the RED-phase TDD prompt for the `mls-test-runner` agent.
   *
...
Write ONE test per acceptance criterion. Do not invent scenarios beyond what the criteria specify. Do not test READMEs, config files, or HTML structure. Run tests to confirm they FAIL (RED).`;
  ...
  /**
   * Build the GREEN-phase TDD prompt for the `mls-impl-engineer` agent.
   *
...
Write the minimum code to make all failing tests pass. Do not add behavior that no test verifies.`;
  ...
  /**
   * Build the review-fix prompt for the `mls-impl-engineer` agent.
   *
...
Fix Must-Fix and Should-Fix issues. Push back on invalid feedback with clear explanation. Do not implement Out-of-Scope items.`;
  ...
  /**
   * Build the test-failure-fix prompt for the `mls-impl-engineer` agent.
   *
...
Fix the failing tests. Do not break passing tests.`;
  ...
  /**
   * Build the test-verification prompt for the `mls-test-runner` agent (task-aware variant).
   *
  ...
  /**
   * Build the test-verification prompt for the `mls-test-runner` agent (simple variant).
   *
  ...
  /**
   * Build the full code-review prompt for the `mls-code-reviewer` agent (task-aware variant).
   *
  ...
  /**
   * Build the code-review prompt for the `mls-code-reviewer` agent (simple variant).
   *
  ...
  /**
   * Build the Group 1 design prompt for the `mls-designer` agent.
   *
  ...
  /**
   * Build the Group 1 infrastructure prompt for the `mls-infra-engineer` agent.
   *
  ...
  /**
   * Build the Group 1 documentation prompt for the `mls-impl-engineer` agent.
   *
