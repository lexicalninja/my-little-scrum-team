...
import type { PrdSessionDeps } from "../.pi/extensions/mls/prd.js";
...
vi.mock("../.pi/extensions/mls/prd.js", async (importOriginal) => {
  const original = await importOriginal<typeof import("../.pi/extensions/mls/prd.js")>();
  return {
    ...original,
    PrdSession: class {
      ...
      async run(_input: string) {
        return { filePath: ".mls/prd-test.md", title: "Test" };
      }
...
vi.mock("../.pi/extensions/mls/orchestrator/index.js", () => ({
  Orchestrator: class {},
}));
...
async function getPrdHandler(): Promise<CommandHandler> {
  const { default: mlsExtension } = await import("../.pi/extensions/mls/index.js");
