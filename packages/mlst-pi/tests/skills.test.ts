...
import { SkillLoader } from "../.pi/extensions/mlst/skills.js";
...
describe("SkillLoader", () => {
  ...
  it("getSkillsForAgent returns formatted section for mlst-designer", () => {
    const loader = new SkillLoader(fixturesDir);
    loader.load();
    const result = loader.getSkillsForAgent("mlst-designer");
