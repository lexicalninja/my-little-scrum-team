...
// ─── AC1: MlstEvent sprint_end variant includes aborted?: boolean and abortReason?: string ──

describe("sprint_end MlstEvent type", () => {
